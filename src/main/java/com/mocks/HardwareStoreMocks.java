package main.java.com.mocks;

/**
 * The type Hardware store mocks.
 */
public class HardwareStoreMocks {

    private final String[][] lawnMower = {
    ...
    private final String[][] lawnTractor = {
    ...
    private final String[][] handDrill = {
    ...
    private final String[][] drillPress = {
    ...
    private final String[][] circularSaw = {
